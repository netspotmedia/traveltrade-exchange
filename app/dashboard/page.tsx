...
import { ArrowUpRight, BriefcaseBusiness, CheckCircle2, CircleDollarSign, FileText, Inbox, ShieldCheck, Store, WalletCards } from 'lucide-react'
...
const workspaces = [
  ...
  { href: '/agent/requests', label: 'Quote requests', detail: 'Respond to incoming RFQs', icon: Inbox },
