        ...
        <div className="mt-6 flex flex-col gap-4">
          {!orders || orders.length === 0 ? (
            ...
            (orders as OrderRow[]).map((o) => (
              <div key={o.id} className="group flex flex-wrap items-center justify-between gap-3 glass-card rounded-[1.25rem] p-5 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-primary/15 hover:-translate-y-0.5 hover:shadow-soft-lg active:scale-[0.995]">
